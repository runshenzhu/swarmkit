...
type ContainerSpec struct {
	...
	HealthCheck     *HealthConfig                 `protobuf:"bytes,10,opt,name=HealthCheck,json=healthCheck" json:"HealthCheck,omitempty"`
}
...
func (*HealthConfig) Descriptor() ([]byte, []int) { return fileDescriptorSpecs, []int{6} }
...
func (m *HealthConfig) Copy() *HealthConfig {
	...
	if m.Test != nil {
		o.Test = make([]string, 0, len(m.Test))
		for _, v := range m.Test {
			o.Test = append(o.Test, v)
		}
	}
...
func (this *HealthConfig) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 8)
	s = append(s, "&api.HealthConfig{")
...
func (m *ContainerSpec) MarshalTo(data []byte) (int, error) {
	...
	if m.HealthCheck != nil {
		...
		n15, err := m.HealthCheck.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n15
...
func (m *HealthConfig) MarshalTo(data []byte) (int, error) {
	...
	if m.Interval != 0 {
		data[i] = 0x10
		i++
		i = encodeVarintSpecs(data, i, uint64(m.Interval))
	}
	if m.Timeout != 0 {
		data[i] = 0x18
		i++
		i = encodeVarintSpecs(data, i, uint64(m.Timeout))
	}
	if m.Retries != 0 {
		data[i] = 0x20
		i++
		i = encodeVarintSpecs(data, i, uint64(m.Retries))
	}
	return i, nil
}
...
func (m *HealthConfig) Size() (n int) {
	...
	if m.Interval != 0 {
		n += 1 + sovSpecs(uint64(m.Interval))
	}
	if m.Timeout != 0 {
		n += 1 + sovSpecs(uint64(m.Timeout))
	}
	if m.Retries != 0 {
		n += 1 + sovSpecs(uint64(m.Retries))
	}
	return n
}
...
var fileDescriptorSpecs = []byte{
	...
	,
}
